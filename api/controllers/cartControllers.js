...
// Get all cart items on the basis of email
...
// this functions handles the add to cart functionality
const addToCart = async (req, res) => {
    ...
    try {
      ...
      if (existingCartItem) {     // If current item already exists in cart dont add again
        return res
          .status(400)
          .json({ message: "Product already exists in the cart" });
      }

      // if element does not exists then create an element and add it
